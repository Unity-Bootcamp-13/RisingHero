...
public class Aura : MonoBehaviour
{
    ...
    public void Initialize(float damage, float radius, float tickInterval, float duration, Transform caster, LayerMask targetLayer)
    {
        this.damage = damage;
        this.radius = radius;
